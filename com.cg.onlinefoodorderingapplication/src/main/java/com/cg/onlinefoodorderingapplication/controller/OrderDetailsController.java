...
import com.cg.onlinefoodorderingapplication.service.IOrderDetailsService;



@CrossOrigin(origins = "http://localhost:4200")
@RestController 
@RequestMapping("/api/od1")
public class OrderDetailsController {
	...
	@GetMapping("/orders/restaurantid={restaurantId}/orderdetails")
	public List<OrderDetails> getOrderDetailsByRestaurantId(@PathVariable(value = "restaurantId") Long restaurantId)
	{
		return orderDetailsService.getOrderDetailsByRestaurantId(restaurantId);
	}
	
	//update orderDetails by orderId and orderDetailsId
	@PutMapping("/orders/orderdetails/{orderDetailsId}")
    public ResponseEntity<OrderDetails> updateRestaurant(@PathVariable(value = "orderDetailsId") Long orderDetailsId,
         @Valid @RequestBody OrderDetails orderDetails) throws ResourceNotFoundException {
		return orderDetailsService.updateRestaurant(orderDetailsId, orderDetails);
    }
